...
In the plots below histograms for gene expression of some important genes in
breast cancer are plotted.
...
focus just on TCGA for simplicity.
...
The plot below shows all the samples from TCGA and cohort projected into the
...
By summing the offset is corrected. The question that remains still is what is
...
the projection is not a function of the stages.
