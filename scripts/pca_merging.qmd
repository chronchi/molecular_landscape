...
stable_genes <- readRDS("../results/rds_files/pca_merging/stable_genes.rds")
...
common_genes <- intersect(rownames(datasets$tcga), rownames(datasets$metabric))
...
The table with the selecte genes is shown below along with their standard
