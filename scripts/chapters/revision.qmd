...
saveRDS(
    sum_exp,
    "../../results/rds_files/revision/sum_exp_mets.rds"
)
...
saveRDS(
    sum_exp_df_pca,
    "../../results/rds_files/revision/sum_exp_df_pca_mets.rds"
)
```
...
```{r, eval = first_run}
# The code below was first used to get the data that is now stored
# in the data folder, so we don't need to actually rerun it anymore
