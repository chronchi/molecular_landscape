...
> Add here the code to make the video when calculating the average
scores. try to use the same code as the poetic, if not, change it 
so it can be used in both cases. Idea is to show how the scores change
as you move across the molecular landscape.
...
as described at [chronchi.github.io/transcriptomics](https://chronchi.github.io/transcriptomics/) in
the chapter AI - GSE105777. 
