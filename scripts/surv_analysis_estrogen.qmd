...
use 10% as the threshold for ER status.
...
forest_plot_fits(
    fit = survival_results$os$metabric, 
    cohort = "metabric", 
    names_coefficients = names_coefficients,
    patients = "ET only, ER+ BC",
    type_survival = "OS",
    clip = c(0.1, 2)
)
```
...
```{r}
survival_results <- saveRDS(
    "../results/rds_files/surv_analysis_estrogen/survival_results.rds"
)
```
