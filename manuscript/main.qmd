...
#|     (d) Same as **a**, colored by the SET ER/PR score.
#|     (e) Biplot using the first and second component of TCGA, METABRIC and
#|     SCANB. (f) Biplot of all possible embeddings of sample given a certain
