...
risk score is based on survival data found in the literature
...
publicly available molecular datasets, such as TCGA, SCAN-B, METABRIC,
...
RNA-sequencing and microarray samples together, also showing how the 
molecular subtypes cluster in a continuous way. The new molecular landscape
...
0.23 to 0.61. In all three cases the upper part of the confidence intervals (CI)
are below 1, with TCGA having the widest CI, possibly due to the fact we
could not subset based on endocrine therapy, only by molecular subtype. 
...
(0.26 and 0.48) and a confidence interval that is not crossing 1. This 
...
among ER+ BC patients in a research environment.
...
by having a small library of RNA-seq samples that are representative of the
