...
[@tcgabrca; @Saal2015; @Curtis2012; @Gao2019]. It is possible
...
(PCA) embeddings and scores. The samples are of 
primary breast cancer from different molecular subtypes and age 
distribution. TCGA was downloaded from Firebrowse, SCANB data
...
embedding converging towards the origin, i.e., the (0,0) coordinates
in the plot. 
...
molecular subtypes (@fig-03 (c)). We show
...
METABRIC. It is also in between the two cohorts. 
...
additional adjuvant therapy targeting this specific pathway. Further
validation is necessary for this point.
...
provide large-scale RNA-sequencing by using BRB-seq.
