...
database [@Subramanian2005] and $SET_{ER/PR}$ from [@Sinn2019].
The individual
...
were below 1 in all cases (Table 1, supplementary material).
...
to left, i.e., moving from a more ER+ status to the ER-. There are
other pathways driving the distinction between samples, such as
G2M checkpoint, epithelial to mesenchymal transition, DNA
repair and others (supplementary figure 2; 2.20 from book).
