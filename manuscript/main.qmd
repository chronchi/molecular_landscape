...
The molecular landscape can help shed light on responders and non responders.
We can embed the POETIC trial samples using the procedure (@fig-04 (a) left). 
Moreover, there are patients across the whole molecular landscape. 
They are 
